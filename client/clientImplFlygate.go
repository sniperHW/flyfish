...
func (this *clientImplFlyGate) getAvaliable() *conn {
...
func (this *clientImplFlyGate) connect(conn *conn) {
...
func (this *clientImplFlyGate) sendCmd(conn *conn, cmd *cmdContext) {
	if nil != conn.session {
...
func (this *clientImplFlyGate) sendAgain(cmd *cmdContext) {
	this.mu.Lock()
...
func (this *clientImplFlyGate) onTimeout(cmd *cmdContext) {
...
func (this *clientImplFlyGate) exec(cmd *cmdContext) {
...
func (this *clientImplFlyGate) onResponse(msg *cs.RespMessage) {
...
func (this *clientImplFlyGate) onQueryGateResp(gates []*sproto.Flygate) (bool, time.Duration) {
	this.mu.Lock()
...
func (this *clientImplFlyGate) queryGate(pdAddr []*net.UDPAddr) {
	go func() {
		closed, delay := this.onQueryGateResp(QueryGate(pdAddr, time.Second))
		if closed {
			return
		} else {
