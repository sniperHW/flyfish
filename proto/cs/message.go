...
func init() {
	...
	requestSpace.Register(&protocol.ScanNextReq{}, uint32(protocol.CmdType_ScanNext))
	...
	responseSpace.Register(&protocol.ScanNextResp{}, uint32(protocol.CmdType_ScanNext))
}
