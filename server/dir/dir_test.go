...
func Test1(t *testing.T) {
	...
	configGate1, err := Gate.LoadConfigStr(configGate1Str)
	assert.Nil(t, err)

	configGate2, err := Gate.LoadConfigStr(configGate2Str)
	assert.Nil(t, err)

	gate1 := Gate.NewGate(configGate1)
	gate2 := Gate.NewGate(configGate2)
