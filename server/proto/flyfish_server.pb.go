...
type QueryRouteInfo struct {
	...
	Sets    []int32 `protobuf:"varint,4,rep,name=sets" json:"sets,omitempty"`
}
...
func (m *QueryRouteInfo) GetService() string {
	if m != nil {
		return m.Service
	}
	return ""
...
func (m *QueryRouteInfo) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
var fileDescriptor_03085fc3fc38bb42 = []byte{
	...
	,
}
