...
const (
	...
	ServerCmdType_UpdateNodeURL        ServerCmdType = 149
	ServerCmdType_UpdateNodeURLResp    ServerCmdType = 150
	//kvnode <-> pd
...
const (
	...
	StoreOpType_UpdateURL      StoreOpType = 4
)
...
func (m *UpdateNodeURL) Reset()      { *m = UpdateNodeURL{} }
func (*UpdateNodeURL) ProtoMessage() {}
func (*UpdateNodeURL) Descriptor() ([]byte, []int) {
	return fileDescriptor_03085fc3fc38bb42, []int{12}
}
func (m *UpdateNodeURL) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateNodeURL) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateNodeURL.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateNodeURL) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateNodeURL.Merge(m, src)
}
func (m *UpdateNodeURL) XXX_Size() int {
	return m.Size()
}
func (m *UpdateNodeURL) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateNodeURL.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateNodeURL proto.InternalMessageInfo

func (m *UpdateNodeURL) GetSetID() int32 {
	if m != nil {
		return m.SetID
	}
	return 0
...
func (m *UpdateNodeURL) GetNodeID() int32 {
	if m != nil {
		return m.NodeID
	}
	return 0
...
func (m *UpdateNodeURL) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *UpdateNodeURL) GetServicePort() int32 {
	if m != nil {
		return m.ServicePort
	}
	return 0
...
func (m *UpdateNodeURL) GetRaftPort() int32 {
	if m != nil {
		return m.RaftPort
	}
	return 0
...
type UpdateNodeURLResp struct {
	Ok     bool   `protobuf:"varint,1,opt,name=ok" json:"ok"`
	Reason string `protobuf:"bytes,2,opt,name=reason" json:"reason"`
}

func (m *UpdateNodeURLResp) Reset()      { *m = UpdateNodeURLResp{} }
func (*UpdateNodeURLResp) ProtoMessage() {}
func (*UpdateNodeURLResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_03085fc3fc38bb42, []int{13}
}
func (m *UpdateNodeURLResp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateNodeURLResp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateNodeURLResp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateNodeURLResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateNodeURLResp.Merge(m, src)
}
func (m *UpdateNodeURLResp) XXX_Size() int {
	return m.Size()
}
func (m *UpdateNodeURLResp) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateNodeURLResp.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateNodeURLResp proto.InternalMessageInfo

func (m *UpdateNodeURLResp) GetOk() bool {
	if m != nil {
		return m.Ok
	}
	return false
...
func (m *UpdateNodeURLResp) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
type KvnodeBootResp struct {
	...
	Join        bool         `protobuf:"varint,9,opt,name=join" json:"join"`
}
...
func (m *KvnodeBootResp) GetJoin() bool {
	if m != nil {
		return m.Join
	}
	return false
...
func init() {
	...
	proto.RegisterType((*UpdateNodeURL)(nil), "proto.updateNodeURL")
	proto.RegisterType((*UpdateNodeURLResp)(nil), "proto.updateNodeURLResp")
...
var fileDescriptor_03085fc3fc38bb42 = []byte{
	...
	,
}
...
func (this *UpdateNodeURL) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpdateNodeURL)
	if !ok {
		that2, ok := that.(UpdateNodeURL)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UpdateNodeURLResp) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpdateNodeURLResp)
	if !ok {
		that2, ok := that.(UpdateNodeURLResp)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UpdateNodeURL) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&proto.UpdateNodeURL{")
	s = append(s, "SetID: "+fmt.Sprintf("%#v", this.SetID)+",\n")
	s = append(s, "NodeID: "+fmt.Sprintf("%#v", this.NodeID)+",\n")
	s = append(s, "Host: "+fmt.Sprintf("%#v", this.Host)+",\n")
	s = append(s, "ServicePort: "+fmt.Sprintf("%#v", this.ServicePort)+",\n")
...
func (this *UpdateNodeURLResp) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&proto.UpdateNodeURLResp{")
	s = append(s, "Ok: "+fmt.Sprintf("%#v", this.Ok)+",\n")
	s = append(s, "Reason: "+fmt.Sprintf("%#v", this.Reason)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
...
func (m *UpdateNodeURL) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateNodeURL) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateNodeURL) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateNodeURLResp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateNodeURLResp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateNodeURLResp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateNodeURL) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateNodeURLResp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *UpdateNodeURL) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateNodeURL{`,
		`SetID:` + fmt.Sprintf("%v", this.SetID) + `,`,
		`NodeID:` + fmt.Sprintf("%v", this.NodeID) + `,`,
		`Host:` + fmt.Sprintf("%v", this.Host) + `,`,
		`ServicePort:` + fmt.Sprintf("%v", this.ServicePort) + `,`,
...
func (this *UpdateNodeURLResp) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateNodeURLResp{`,
		`Ok:` + fmt.Sprintf("%v", this.Ok) + `,`,
		`Reason:` + fmt.Sprintf("%v", this.Reason) + `,`,
		`}`,
	}, "")
...
func (m *UpdateNodeURL) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: updateNodeURL: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: updateNodeURL: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *UpdateNodeURLResp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: updateNodeURLResp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: updateNodeURLResp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
