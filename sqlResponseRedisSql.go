...
type sqlResponseRedisSql struct {
}

func (this *sqlResponseRedisSql) onSqlNotFound(ctx *processContext) {
...
func (this *sqlResponseRedisSql) onSqlLoadOKGet(ctx *processContext) {
...
*   设置类命令簇
 */
func (this *sqlResponseRedisSql) onSqlLoadOKSet(ctx *processContext) {
...
func (this *sqlResponseRedisSql) onSqlLoadOKDel(ctx *processContext) {
	var errCode int32
	version := ctx.fields["__version__"].GetInt()
	cmd := ctx.commands[0]
	ckey := ctx.getCacheKey()
...
func (this *sqlResponseRedisSql) onSqlLoadOK(ctx *processContext) {
	cmdType := ctx.getCmdType()
	if cmdType == cmdGet {
...
func (this *sqlResponseRedisSql) onSqlResp(ctx *processContext, errno int32) {
...
func (this *sqlResponseRedisSql) onSqlWriteBackResp(ctx *processContext, errno int32) {
